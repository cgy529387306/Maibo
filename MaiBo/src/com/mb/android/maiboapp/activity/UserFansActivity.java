 ...
 */
public class UserFansActivity extends BaseSwipeBackActivity {
    ...
    private void initUI() {
        ...
        mAdapter = new UserFansAdapter(UserFansActivity.this,dataList);
		// 添加头部
        ...
        mAdapter.setItemHandler(new ItemHandler() {
			...
			public void onFollow(int pos) {
				...
				if (entity.getFollow_state() == 2) {
					...
					postion = pos;
					DialogHelper.showConfirmDialog(UserFansActivity.this, "取消关注","确定不再关注此人?", 
    ...
    private DialogInterface.OnClickListener mPositiveListener = new DialogInterface.OnClickListener() {
		...
		public void onClick(DialogInterface dialog, int which) {
			ProgressLoadingHelper.showLoadingDialog(UserFansActivity.this);
    ...
    private void requestData(int requestType) {
        ...
        get(ProjectConstants.Url.ACCOUNT_FANCE, requestMap, requestType);
    }
	...
	private void showGroup(final UserEntity entity){
		if (Helper.isEmpty(groupList)) {
  		...
  		SimpleAdapter adapter = new SimpleAdapter(UserFansActivity.this,  

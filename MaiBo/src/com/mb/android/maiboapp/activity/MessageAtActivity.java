 ...
 */
public class MessageAtActivity extends BaseSwipeBackActivity {
	...
	private void initUI() {
		...
		mAdapter = new WeiboAdapter(MessageAtActivity.this, dataList,1);
		...
		mRefreshListView.setOnItemClickListener(mItemClickListener);
		 ...
		 mAdapter.setItemHandler(new ItemHandler() {
				...
				public void onRepost(int pos) {
					...
					NavigationHelper.startActivity(MessageAtActivity.this,
	...
	private void requestData(int requstType) {
		...
		get(ProjectConstants.Url.MESSAGE_AT, requestMap, requstType);
	}

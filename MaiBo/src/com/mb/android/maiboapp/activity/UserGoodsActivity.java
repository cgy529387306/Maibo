 ...
 */
public class UserGoodsActivity extends BaseSwipeBackActivity {
    ...
    private void initUI() {
        ...
        mAdapter = new WeiboAdapter(UserGoodsActivity.this,dataList,1);
        ...
        mAdapter.setItemHandler(new ItemHandler() {
			...
			public void onRepost(int pos) {
				...
				NavigationHelper.startActivity(UserGoodsActivity.this,
    ...
    private void requestData(int requstType) {
        ...
        get(ProjectConstants.Url.ACCOUNT_GOOD, requestMap, requstType);
    }

...
public class UserFollowAdapter extends BaseAdapter{
	...
	public UserFollowAdapter(Activity act,List<UserEntity> list) {
		this.activity = act;
		this.dataList = list;
	}
	@Override
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (Helper.isNull(convertView)) {
			...
			convertView = LayoutInflater.from(activity).inflate(R.layout.item_user_follow, null);
	    ...
	    if (entity.getFollow_state() == 2) {
			...
			holder.imv_follow.setImageResource(R.drawable.ic_follow_each);
		}

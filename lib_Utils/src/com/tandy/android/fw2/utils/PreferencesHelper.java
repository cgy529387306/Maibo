...
public class PreferencesHelper {
	...
	public static PreferencesHelper getInstance(String sharedPreferencesName){
		...
		if (useDefault){
			sInstance.mSharePreferences = PreferenceManager.getDefaultSharedPreferences(WpApplication.getInstance());
			sLastSharedPreferencesName = null;
		}else{
			sInstance.mSharePreferences = WpApplication.getInstance().getSharedPreferences(sharedPreferencesName, Context.MODE_PRIVATE);
